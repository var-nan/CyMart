...
public class SetupScript {
    ...
    static void setUp() {
        ...
        try {
            ...
            // resources path
            if ((zooKeeper.exists(ZK_RESOURCES_PATH, null)) != null) {
                zooKeeper.delete(ZK_RESOURCES_PATH, -1);
            }
            zooKeeper.create(ZK_RESOURCES_PATH, new byte[0], OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
